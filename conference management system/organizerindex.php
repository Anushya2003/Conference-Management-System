...
<head>
  ...
  .card {
    padding: 32px; /* Increase padding for better readability on smaller screens */
  }
}
        body {
            background-image: url("organi.jpg");
    ...
    width: 100%;
    height: 100vh;
    margin: 0; /* Optional: This removes default margin */
    padding: 0;
...
<body>
    <div class="grid">
        <div class="card">
         ...
         <a href="organi.php"> <h4>CREATED CONFERENCE</h4></a>
          <p>
        ...
        <div>
        <a href="addconf.php"><div class="card">
          <span class="icon">
            <svg
              viewBox="0 0 24 24"
              fill="none"
